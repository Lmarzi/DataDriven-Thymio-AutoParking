...
for tempo in range(0, min, 1):
    ...
    for misura in range(0, len(tutte_velocita), 1):
        velocita_media_sinistra += tutte_velocita[misura][0][tempo] / 3
        velocita_media_destra += tutte_velocita[misura][1][tempo] / 3
...
np.save("Veocita_nominale_3", velocita_media_array)
